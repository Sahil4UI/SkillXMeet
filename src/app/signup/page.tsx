...
const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path fill="currentColor" d="M12.48 10.92v3.28h7.84c-.24 1.84-.85 3.18-1.73 4.1-1.02 1.02-2.9 2.04-5.07 2.04-4.34 0-7.84-3.52-7.84-7.84s3.5-7.84 7.84-7.84c2.47 0 4.02.98 4.94 1.9l2.6-2.6C18.47 2.45 15.82 1 12.48 1 7.18 1 3 5.18 3 10.48s4.18 9.48 9.48 9.48c5.42 0 9.1-3.87 9.1-9.33 0-.64-.07-1.25-.19-1.84h-8.91z"/>
    </svg>
);
